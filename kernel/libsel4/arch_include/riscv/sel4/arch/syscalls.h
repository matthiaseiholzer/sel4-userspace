...
LIBSEL4_INLINE_FUNC void riscv_sys_reply(seL4_Word sys, seL4_Word info_arg, seL4_Word mr0, seL4_Word mr1, seL4_Word mr2,
                                   seL4_Word mr3)
{
    register seL4_Word info asm("a1") = info_arg;
...
LIBSEL4_INLINE_FUNC void riscv_sys_send_null(seL4_Word sys, seL4_Word src, seL4_Word info_arg)
{
...
LIBSEL4_INLINE_FUNC void riscv_sys_recv(seL4_Word sys, seL4_Word src, seL4_Word *out_badge, seL4_Word *out_info, seL4_Word
...
LIBSEL4_INLINE_FUNC void riscv_sys_send_recv(seL4_Word sys, seL4_Word dest, seL4_Word *out_badge, seL4_Word info_arg,
                                       seL4_Word
